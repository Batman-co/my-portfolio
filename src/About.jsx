    ...
    return(
        <motion.div initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} viewport={{once:true, amount:0.2}} transition={{duration:1}} className="relative h-auto w-auto mb-[150px]">
            ...
            <div className="bg-[#e4e4e4] lg:w-[1116px] lg:h-[408px] md:w-[900px] md:h-[338px] sm:w-[500px] sm:h-[548px] m-auto relative inset-0 bg-opacity-70 sm:pt-5 backdrop-blur-md rounded-xl top-24 flex md:flex-row sm:flex-col items-center justify-evenly sm:gap-5 mt-14">
                ...
                <p className="lg:w-[550px] md:w-[530px] h-[180px] sm:w-[400px] sm:h-[250px] md:text-left sm:text-center sm:text-sm lg:leading-loose md:leading-relaxed font-poppins mb-8">I excel in using Webflow to create dynamic, responsive, and visually appealing websites. My skills enable me to translate complex design concepts into interactive web experiences, utilizing Webflow's CMS for scalable content structures. I prioritize performance, accessibility, and SEO, ensuring each project is optimized and user-friendly. Through continuous learning, I stay updated with the latest Webflow features to deliver innovative and high-quality web solutions tailored to each client's needs.</p>
            </div>
        </motion.div>
    )
}
